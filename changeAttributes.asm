...
loadf f14,r11,0x3E19999A			#loads 0.15 into f14
stfs f14,0x33C(r3)			#running speed
stfs f14,0x340(r3)			#running accel
stfs f14,0x384(r3)			#running air speed


loadf f14,r11,0x3A83126F			#loads 0.001 into f14
#stfs f14,0x4CC(r3)			#float air friction
stfs f14,0x374(r3)			#air friction

loadf f14,r11,0x3c23d70a			#loads 0.01 into f14
stfs f14,0x32C(r3)			#ground friction

loadf f14,r11,0x3DCCCCCD			#loads 0.1 into f14
stfs f14,0x4d0(r3)			#float air speed forward
stfs f14,0x378(r3)			#walking air speed forward
stfs f14,0x330(r3)			#walk max ground speed

loadf f14,r11,0x3CF5C28F			#loads 0.1 into f14
stfs f14,0x334(r3)			#float air speed forward
